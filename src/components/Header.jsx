...
const Header = () => {
  return (<>
    <header className='bg-[#101828] py-4 px-5 text-gray-300 flex flex-row justify-between md:justify-around'>
      ...
      <div className='flex flex-row items-center justify-center'>
        <h2 className='bg-white text-black cursor-pointer rounded-lg hover:bg-black hover:bg-gray-200 transition duration-300  py-3 px-3.5 font-semibold text-lg'>Signup</h2>
      </div>
